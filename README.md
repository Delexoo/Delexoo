...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 240" width="100%" role="img" aria-label="♡">
  ...
  <text x="600" y="108" text-anchor="middle" fill="#ffffff" font-family="Segoe UI, system-ui, sans-serif" font-size="72" font-weight="700" letter-spacing="2"></text>
  <text x="600" y="152" text-anchor="middle" fill="#e94560" font-family="Segoe UI, system-ui, sans-serif" font-size="22" font-weight="500" letter-spacing="4">♡ amp;</text>
